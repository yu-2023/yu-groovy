 ...
 *
 * Groovy program     GRO_10_tabs.groovy     Apache License 2.0
 *
...
/** GRO_10_tabs */
public final class GRO_10_tabs_class {
...
/** GRO_10_tabs demonstrates Groovy Tabs in Groovy Frame */
public GRO_10_tabs_class() {

//------------------------------

        var imgURL =               GRO_10_tabs.class.getResource("/lv/yu/gro/GRO_resources/GRO.jpg")
    var icon_frame = new ImageIcon(GRO_10_tabs.class.getResource("/lv/yu/gro/GRO_resources/GRO.jpg"))

//------------------------------

    var title = "GROOVY -- GRO_10_tabs -- v. 2023.12.12"
...
//--------------------------------------------------
    ...
    def GRO_start_visualize_10_class = new lv.yu.gro.start.GRO_start_visualize_10_class()
 ...
 */
    public static void main(String[] args) {
                                             SwingUtilities.invokeLater( () -> { new GRO_10_tabs_class() } )
    }  //  end main()
