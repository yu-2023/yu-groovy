 ...
 *
 * Groovy program     GRO_lang_menu_lang_09.groovy     Apache License 2.0
 *
...
/**
 * GRO_lang_menu_lang_09
 */
public class GRO_lang_menu_lang_09_class {

/**
 * GRO_lang_menu_lang_09()
 */
    public GRO_lang_menu_lang_09_class() {

//------------------------------

    var icon_Eng = new ImageIcon( getClass().getResource("/lv/yu/gro/GRO_resources/prefs.gif") )
    var icon_Rus = new ImageIcon( getClass().getResource("/lv/yu/gro/GRO_resources/prefs.gif") )
    var icon_Lat = new ImageIcon( getClass().getResource("/lv/yu/gro/GRO_resources/prefs.gif") )
...
//------------------------------
        ...
        lv.yu.gro.GRO_09_internal_frames_change_class.menubar.add(menu_Lang)

//------------------------------

    }  //  end GRO_lang_menu_lang_09_class()
