 ...
 *
 * Groovy program     GRO_03_menu.groovy     Apache License 2.0
 *
...
/** GRO_03_menu */
public final class GRO_03_menu_class {
...
/** GRO_03_menu demonstrates Groovy Menu in Groovy Frame */
public GRO_03_menu_class() {

        var imgURL =               GRO_03_menu_class.class.getResource("/lv/yu/gro/GRO_resources/GRO.jpg")
    var icon_frame = new ImageIcon(GRO_03_menu_class.class.getResource("/lv/yu/gro/GRO_resources/GRO.jpg"))

//------------------------------

    var title = "GROOVY -- GRO_03_menu -- v. 2023.12.12"
...
//------------------------------
    ...
    var icon_Start       = new ImageIcon(GRO_03_menu_class.class.getResource("/lv/yu/gro/GRO_resources/start.gif"))
    var icon_Load        = new ImageIcon(GRO_03_menu_class.class.getResource("/lv/yu/gro/GRO_resources/load.gif"))
    var icon_Xxxx        = new ImageIcon(GRO_03_menu_class.class.getResource("/lv/yu/gro/GRO_resources/xxxx.png"))
    var icon_Information = new ImageIcon(GRO_03_menu_class.class.getResource("/lv/yu/gro/GRO_resources/information.gif"))
    var icon_Help        = new ImageIcon(GRO_03_menu_class.class.getResource("/lv/yu/gro/GRO_resources/help.png"))
    var icon_About       = new ImageIcon(GRO_03_menu_class.class.getResource("/lv/yu/gro/GRO_resources/about.gif"))
    var icon_Eng         = new ImageIcon(GRO_03_menu_class.class.getResource("/lv/yu/gro/GRO_resources/prefs.gif"))
    var icon_Rus         = new ImageIcon(GRO_03_menu_class.class.getResource("/lv/yu/gro/GRO_resources/prefs.gif"))
    var icon_Lat         = new ImageIcon(GRO_03_menu_class.class.getResource("/lv/yu/gro/GRO_resources/prefs.gif"))
    var icon_Exit        = new ImageIcon(GRO_03_menu_class.class.getResource("/lv/yu/gro/GRO_resources/exit.png"))
 ...
 */
    public static void main(String[] args) {
                                             SwingUtilities.invokeLater( () -> { new GRO_03_menu_class() } )
    }  //  end main
