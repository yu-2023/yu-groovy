 ...
 *
 * Groovy program     GRO_02_text.groovy     Apache License 2.0
 *
...
/** GRO_02_text */
public final class GRO_02_text_class {
...
/** GRO_02_text demonstrates Groovy Text in Groovy Frame */
public GRO_02_text_class() {

        var imgURL =               GRO_02_text_class.class.getResource("/lv/yu/gro/GRO_resources/GRO.jpg")
    var icon_frame = new ImageIcon(GRO_02_text_class.class.getResource("/lv/yu/gro/GRO_resources/GRO.jpg"))

//------------------------------

    var title = "GROOVY -- GRO_02_text -- v. 2023.12.12"
 ...
 */
    public static void main(String[] args) {
                                             SwingUtilities.invokeLater( () -> { new GRO_02_text_class() } )
    }  //  end main
